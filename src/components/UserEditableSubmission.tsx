...
const UserEditableSubmission: React.FC<Props> = props => {
    const { initialSubmission, issues, onClose } = props;
    ...
    // Destructure state
    const { submission, additionalRefIndex, showLoading } = state;
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="flex flex-row w-[100%] justify-between">
                            <div className="UserEdit-image-container flex items-start">
                                <img
                                    src={
                                        state.submission.mainSubmission.imageUrl
                                    }
                                    alt="Submission"
                        ...
                        {state.submission.additionalReferences?.length &&
                        state.submission.additionalReferences?.length > 0 ? (
                            <div
                    ...
                    <div className="w-full flex justify-between pb-2">
                        <div className="flex items-center">
                            <button
                                ...
                                className="text-lg font-semibold UserEdit-bottombutton"
                            >
                                Delete Submission
                            </button>
                        </div>
                        ...
                        <div className="flex-col items-center py-2 UserEdit-textbox w-[100%]">
                            <div className="title p-2 text-left">
                                ...
                                <span className="font-medium">
                                    {submission.mainSubmission.title}
                                </span>
                            </div>
                            <div className="image-description text-black p-2 text-left">
