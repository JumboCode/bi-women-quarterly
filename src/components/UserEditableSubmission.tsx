        ...
        switch (action.type) {
            ...
            case ActionType.RemoveAdditionalRef: {
                if (state.submission.additionalReferences != undefined) {
                    ...
                    throw Error(
                        "Trying to remove when there are no additional references"
                    );
                }
            }
        ...
        >
            <div className="w-[70%] mt-[5%]">
                <form className="flex flex-row justify-start mb-4">
                    <button
                        className="text-white px-4 py-2 mb-4 inline-block absolute top-0 left-0"
                ...
                <form onSubmit={onSubmit}>
                    ...
                    {state.submission.additionalReferences?.map((image, index) => (
                        ...
                        <div
                            className="flex flex-row w-[100%] justify-between mt-[10%]"
                            key={index}
                        >
                    ...
                    <div>
                        ...
                        <div className=" UserEdit-textbox">
                            <textarea
                                ...
                                className=" UserEdit-inputbox flex-col items-center py-2 p-[50px] mb-[10%] max-w-[100%] "
                        ...
                        <div className="selectBox">
                            ...
                            <div>
                                <select
                                    ...
                                    value={state.submission.mainSubmission.type}
                                >
                                    <option selected>
                                        {state.submission.mainSubmission.type}
                                    </option>
