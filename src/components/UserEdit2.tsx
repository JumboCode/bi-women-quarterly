...
const UserEditableSubmission: React.FC<Props> = ({
        ...
        switch (action.type) {
            ...
            case ActionType.UpdateAdditional: {
                ...
                if (state.submission.additionalReferences != undefined) {
                    const newPreviews = [
                        ...state.submission.additionalReferences.slice(
                            0,
                            action.index
                        ),
                        {
                            ...state.submission.additionalReferences[
                                action.index
                            ],
                            [action.field]: action.value
                        },
                    ...
                    throw Error(
                        "Trying to edit when there are no additional references"
                    );
                }
            }
    ...
    const initialState = {
        submission: initialSubmission,
        additionalRefIndex: initialSubmission.additionalReferences
            ? initialSubmission.additionalReferences.length - 1
            : -1,
        initialAddRefIndex: initialSubmission.additionalReferences
            ? initialSubmission.additionalReferences.length - 1
            : -1
    };
    ...
    const handleMainSubmissionChange = (
        e:
    ...
    const handleUpdateAdditionalRef = (
        index: number,
        e:
            | React.ChangeEvent<HTMLInputElement>
            | React.ChangeEvent<HTMLTextAreaElement>
    ...
    // That's where I added the admin view submission, in the edit section
    const body = editOn ? (
                ...
                <form onSubmit={onSubmit}>
                    <div className="title-date flex items-center justify-between mb-4">
                        <div className="flex flex-row">
                            ...
                            >
                                <FontAwesomeIcon icon={faLink} /> &nbsp; Google
                                Drive
                            </button>
                        </div>
                    ...
                    <div className="flex flex-row w-[100%] justify-between">
                        <div className="flex flex-col items-start">
                            <div className="UserEdit-image-container flex items-start">
                                <img
                                    ...
                                    alt="Submission"
                                    className="UserEdit-image max-w-[100%] mb-[20%] rounded-lg"
                                />
                            </div>
                        ...
                        <div className="flex flex-col justify-start max-w-[55%] ml-auto">
                            <div className="mt-[5%]">
                                ...
                                <div className="UserEdit-textbox flex-col items-center mb-[10%]">
                                    <textarea
                                        name="notes_to_team"
                                        className="UserEdit-inputbox"
                                        // value={state.submission.notes_to_team}
                                        onChange={handleSubmissionChange}
                                    />
                                </div>
                            </div>
                    ...
                    {state.submission.additionalReferences?.map(
                        (additionalReference, index) => (
                            <div
                                className="flex flex-col w-full justify-between mt-[5%] mb-[10%]"
                                key={index}
                            >
                                <div className="additional-image mb-[5%]">
                                    <div className="UserEdit-image-container flex items-start">
                                        <img
                                            src={
                                                additionalReference.imageUrl
                                            }
                                ...
                                <div className="flex-col items-center py-2 UserEdit-textbox max-w-[35%] w-[100%]">
                                    <div className="title p-[5%] text-left">
                                        <b style={{ color: "#395EB9" }}>
                                            Title
                                        </b>
                                        <br></br>
                                        <input
                    ...
                    <div className="mt-[10%] ">
                        ...
                        <div className=" UserEdit-textbox flex-col items-center py-2 p-[50px] mb-[10%] max-w-[35%] ">
                            <textarea
                    ...
                    <div>
                        ...
                        <div className=" UserEdit-textbox max-w-[35%]">
                            <textarea
                                name="editor_note"
            ...
            <div className="mt-[5%] w-[70%] ">
                ...
                {state.submission.additionalReferences?.map(
                    (additionalReference, index) => (
                        <div
                            key={index}
                            className="flex flex-row w-[100%] justify-between mt-[5%]"
                        >
                            <div className="UserEdit-image-container flex items-start">
                                <img
                ...
                <div className=" bottom-0 left-0 w-full flex justify-between my-[10%]">
                    <div className='p-3 flex items-center"'>
                        <button
                            ...
                            className="UserEdit-bottombutton"
                        >
                            Delete Submission
                        </button>
                    </div>
