                    ...
                    <>
                        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                            <div className="w-screen pt-[10px] max-w-3xl border-0 rounded-md shadow-lg relative flex flex-col w-full bg-[#c3cde3] outline-none focus:outline-none">
                                                ...
                                                <div className="inline-flex items-center">
                                                    <label className="relative flex items-center p-3 rounded-full cursor-pointer">
                                                        <input
                                                            ...
                                                            className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-full bg-white border border-black checked:border-[#395fbb]"
                                                        />
                                                    ...
                                                    <label className="text-black cursor-pointer select-none">
                                                        {" "}
                                                        Submission Piece{" "}
                                                    </label>
                                                </div>
                                                ...
                                                <div className="inline-flex items-center">
                                                    <label className="relative flex items-center p-3 rounded-full cursor-pointer">
                                                        <input
                                                            ...
                                                            type="radio"
                                                            value={
                                                                PreviewType.AdditionalReference
                                                            }
                                                            className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-full bg-white border border-black checked:border-[#395fbb]"
                                                        />
                                                        <span className="absolute transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100">
                                ...
                                >
                                    <label className="flex items-start justify-between py-2 px-5 rounded-t text-black font-bold">
                                        Title of Piece *
                                    </label>
                                    <input
                                        className="appearance-none ml-4 bg-transparent border-none w-full text-[#676c75] mr-3 px-2 leading-tight focus:outline-none"
                                        type="text"
                                ...
                                <div className="flex items-center justify-end p-6 rounded-b">
                                    <button
                                        className="bg-[#ec4899] text-white h-[40px] w-[90px] items-center rounded-lg shadow shadow-lg outline-none focus:outline-none mr-1 mb-1"
                                        type="button"
        ...
        <div>
            <form>
                ...
                <div>
                    {" "}
                    {showModal ? (
                        <SubmissionModal handleNewPreview={handleNewPreview} />
                    ) : null}{" "}
                </div>
