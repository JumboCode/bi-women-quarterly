...
const ProfileReview: React.FC<{}> = () => {
    ...
    const currentUser = user ?? {
        primaryEmailAddressId: "alexandra_orange@test.com",
        unsafeMetadata: {
        ...
        body = (
            <form onSubmit={handleSubmit} id="profileEdit" className="p-10 px-20 bg-[#BFCAE6]">
                ...
                <div className="bg-white border border-solid border-slate-400 rounded-xl mb-5 p-5">
                    ...
                    <input className="border-b-2 my-4 w-80" type="text" id="email" defaultValue={currentUser!.primaryEmailAddressId!} onChange={(e) => handleChange('email', e.target.value)} required /><br />
                    ...
                    <div className="grid md:grid-cols-3 grid-cols-2 xl:pr-96">
                        ...
                        <div>
                            ...
                            <select className="my-4 bg-gray-300 rounded w-48" form="profileEdit" name="profileEdit" id="gender" defaultValue={userInfo?.raceEthnicity}>
                                <option value="default">Select</option>
